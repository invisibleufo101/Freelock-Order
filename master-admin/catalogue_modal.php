            ...
            <div id="carousel-showcase-<?php echo $pfrow['productid'];?>" class="carousel slide">
                ...
                if (empty($images)){
                    ...
                    <div class="item active">
                        <img class="showcase" src="<?php echo BASE_URL?>/static/upload/noimage.jpg">
                        <div class="carousel-caption">
                            <h3 style="color:white; font-family:arial"><mark><?php echo $pfrow['productname'];?></mark></h3>
                        </div>
                    </div>
                    <?php
                }
                    ...
                    for ($i=0; $i<count($images); $i++){
                        if ($i == 0){
                            ...
                            <div class="item active">
                                ...
                                <div class="carousel-caption">
                                    <p style="color:white; font-family:arial"><mark><?php //echo $pfrow['productname'];?></mark></p>
                                </div>
                            </div>
                            <?php
                        }
                ...
                if (count($images) > 1){
                    ?>
                    <a class="carousel-control-prev" href="#carousel-showcase-<?php echo $pfrow['productid'];?>" role="button" data-slide="prev">
                    <span class="glyphicon glyphicon-chevron-left" aria-hidden="true" style="font-size: 50px;"></span>
                    <span class="sr-only">Previous</span>
                    </a>

                    <a class="carousel-control-next" href="#carousel-showcase-<?php echo $pfrow['productid'];?>" role="button" data-slide="next">
                ...
                <div class="carousel-inner" role="listbox">
                    ...
                    if (empty($images)){
                        ...
                        <div class="item active">
                            ...
                            <div class="carousel-caption">
                                <p style="color:white; font-family:arial"><mark><?php echo $prow['productname'];?></mark></p>
                            </div>
                        </div>
                        <?php
                    }
                        ...
                        for ($i=0; $i<count($images); $i++){
                            if ($i == 0){
                                ...
                                <div class="item">
                                    <img class="showcase" src="<?php echo $images[$i] ?>">
                                    <div class="carousel-caption">
                                        <h3 style="color:white; font-family:arial"><mark><?php echo $prow['productname'];?></mark></h3>
                                    </div>
                                </div>
                                <?php
                            }
